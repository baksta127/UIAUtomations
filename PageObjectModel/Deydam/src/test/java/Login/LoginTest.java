...
public class LoginTest {
    ...
    public void setUp() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys("gavin");
        driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("user1111");
    ...
    public void testNegativeLogin(){
        driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys("gavvvin");
